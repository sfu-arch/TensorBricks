...
/** TensorLoad.
  ...
  */
class MacPWIO[gen <: Shapes](NumMac: Int, wgtTensorType: String = "none")
...
class MacPW[L <: Shapes, K <: Shapes : OperatorDot : OperatorReduction](NumMac: Int, wgtTensorType: String = "none")
