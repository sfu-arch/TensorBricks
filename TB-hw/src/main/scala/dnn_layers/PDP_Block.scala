...
import node.{FPvecN, Shapes, vecN}
import shell._
...
/** TensorLoad.
  ...
  */
class PDP_BlockIO[gen <: Shapes, gen2 <: Shapes]
...
class PDP_Block[L <: Shapes, K <: Shapes : OperatorDot : OperatorReduction, M <: Shapes : OperatorDot : OperatorReduction]
...
//  val mac1DshapeOut = new vecN(1, 0, false)
  val mac1DshapeOut = new FPvecN(1, S, 0)
