...
if __name__ == '__main__':
    ...
    result_file = result_dir + '/isonet_latency_'+ model_name +'_.csv'

    isonet_dict = {}
    isonet_latency = pd.DataFrame()
    for folder in folders_list:
        ...
        for file in os.listdir(current_folder):
            if file.endswith(".csv"):
                ...
                print('{},{},{}'.format(folder,schedule_name,total_cycles))
                isonet_dict[folder][schedule_name] = total_cycles
