...
plt.gcf().subplots_adjust(bottom=0.35, right=0.99, top=0.90)
...
ax.set_xticklabels(df['layer'], fontsize=30)
...
ax.text(4, +1.03, 'Middle Layers', fontsize=30)
ax.text(8, +1.03, 'Late Layers', fontsize=30)
