...
SingleLayerDataflow=['HWFCSchedule', 'CFHWSchedule', 'HWCFSchedule2', 'FCHWSchedule']
TwoLayerDataflow=['HWCFScheduleDP', 'HWFCScheduleCC', 'HWCFScheduleCC', 'FCHWScheduleCC',
                  'CFHWScheduleCC']
ThreeLayerDataflow=['FCHW_SchedulePDP', 'HWFC_SchedulePDP', 'HWCF_SchedulePDP',
                    'CFHW_SchedulePDP']
...
if __name__ == '__main__':
    ...
    for model_name in model_names[0:1]:
        ...
        for dataflow in TwoLayerDataflow[1:2]:
            # 'cf_cfhw' is inner dataflow and is fixed.
