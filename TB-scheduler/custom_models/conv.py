    ...
    def __init__(self, _cin=3, _cout=6,_cout2=3, _stride=1):
        ...
        def conv_dw(inp, oup, oup2, stride):
            return nn.Sequential(
                nn.Conv2d(inp, oup, kernel_size=3, stride=1, padding=0, bias=False),
                nn.Conv2d(oup, oup2, kernel_size=3, stride=stride, padding=0, bias=False)
            )
...
if __name__ == '__main__':
    ...
    ds = CONV(_cin=3, _cout=6, _cout2=3, _stride=1)
    speed(ds, 'CONV layer')
