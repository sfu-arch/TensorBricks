...
from dnn_schedules.cross_layer.two_layer.hwfc_cc import HWFCScheduleCC as OrigHWFCScheduleCC
from dnn_schedules.cross_layer.two_layer.hwfc_cc import conv_conv
...
class HWFCScheduleCC(OrigHWFCScheduleCC):
    ...
    def __str__(self):
        return 'Resnet_hwfc_{}_schedule_cc_{}'.format(self.second_pw_dataflow, self.hw_type)
