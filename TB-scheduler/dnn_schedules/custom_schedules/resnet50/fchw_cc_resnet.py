from dnn_schedules.cross_layer.two_layer.fchw_cc import FCHWScheduleCC as OrigFCHWScheduleCC
from dnn_schedules.cross_layer.two_layer.fchw_cc import conv_conv
...
class FCHWScheduleCC(OrigFCHWScheduleCC):
    ...
    def __str__(self):
        return 'Resnet_fchw_{}_schedule_cc_{}'.format(self.second_pw_dataflow, self.hw_type)
