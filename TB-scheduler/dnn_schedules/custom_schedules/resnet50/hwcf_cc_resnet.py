...
from dnn_schedules.cross_layer.two_layer.hwcf_cc import HWCFScheduleCC as OrigHWCFScheduleCC
from dnn_schedules.cross_layer.two_layer.hwcf_cc import conv_conv
...
class HWCFScheduleCC(OrigHWCFScheduleCC):
    ...
    def __str__(self):
        return 'Resnet_hwcf_{}_schedule_cc_{}'.format(self.second_pw_dataflow, self.hw_type)
