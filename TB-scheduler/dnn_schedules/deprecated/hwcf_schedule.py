...
class HWCFSchedule(HWCSchedule):
    ...
    def conv2d_pw(self, layer_attr, hw_params, init_start_cout_idx=0, init_start_hout_idx=0, init_start_wout_idx=0,
        ...
        wgt_volume = layer_attr.Cout * layer_attr.Cin * 1 * 1
        if not is_cross_layer:
        ...
        for hin in range(0, layer_attr.Hin, hw_params.hxx):
            ...
            for win in range(0, layer_attr.Win, hw_params.wxx):
                ...
                for cin in range(0, layer_attr.Cin, hw_params.cxx):
                    self.conv2d_pw_block(cin, win, hin, start_wout_idx, start_hout_idx, layer_attr, hw_params,
                                         is_cross_layer,
    ...
    def conv2d_pw_block(self, cin, win, hin, start_wout_idx, start_hout_idx, layer_attr, hw_params,
        ...
        for f in range(0, layer_attr.Cout, hw_params.fx):
            ...
            num_mac_cycles_all_filters += num_h_convs
            self.stats['cumm_mac_cycles'][layer_attr.layer_idx] += num_partial_convs
            self.stats['theoretical_max_mac_cycles'][
                layer_attr.layer_idx] += hw_params.fx * hw_params.cxx * num_macs_wx * num_h_convs
        ...
        if cin != 0 or (is_cross_layer and (init_start_cout_idx != 0)):
            ...
            total_padd_cycles = layer_attr.Cout * num_wout * math.ceil(num_hout/hw_params.padd_unit)
