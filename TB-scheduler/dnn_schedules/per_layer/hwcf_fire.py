...
class HWCFScheduleFire(HWCFSchedule):
        ...
        while idx < len(items):
            ...
            if idx + 2 < len(items):
                ...
                if current_layer.attr_type == 'PW' and next_layer.attr_type == 'PW' \
                    ...
                    self.fire_conv(current_layer, next_layer, next_next_layer)
                    idx += 3
                    continue
...
#-------------------------------------------
            ...
            if current_layer.attr_type == '3d':
                ...
                per_layer_hw_params = self.load_hw_params_conv(True, False, config=4)
